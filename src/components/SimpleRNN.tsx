...
export default function SimpleRNN(){
    ...
    <h1>Simple RNN</h1>
        ...
        <p>
            ...
            <ul>
                <li><MathJax>{"\\(\\vec{d}_i\\): \\(i\\)-th desired output, \\(i \\in \\{1,2,3\\}\\). - given to the network."}</MathJax></li>
                <li><MathJax>{"\\(\\vec{y}_i\\): \\(i\\)-th calculated output, \\(i \\in \\{1,2,3\\}\\). - extracted from the network."}</MathJax></li>
                <li><MathJax>{"\\(\\mathcal{E}\\): Expected value"}</MathJax></li>
                <li><MathJax>{"\\(\\mathcal{L}\\): loss function"}</MathJax></li>
                <li><MathJax>{"\\(E\\): error"}</MathJax></li>
            </ul>
        </p>
        ...
        <h3>Update weight matrices <MathJax>{"\\(W_y, W_s\\)"}</MathJax> and <MathJax>{"\\(W_x\\)"}</MathJax> at time <MathJax>{"t=3"}</MathJax></h3>
        NOTE: <MathJax>
            {
                "\\(E_3 = E_3(\\vec{y}_3(W_y, \\vec{s}_3(\\vec{x}_3, W_x,W_s, \\vec{s}_2(W_x, \\vec{x}_2, W_s, \\vec{s}_1(\\vec{x}_1, W_x, W_s, 0)))))\\)."
            }
            </MathJax>
